        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseFaqs_Courses_CoursesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseSections_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CoursesId = table.Column<Guid>(type: "uuid", nullable: false),
                    CourseLessonsId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonProgresses_CourseLessons_CourseLessonsId",
                        column: x => x.CourseLessonsId,
                        principalTable: "CourseLessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonProgresses_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseFaqs_CoursesId",
                table: "CourseFaqs",
                column: "CoursesId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseInstructors_CoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSections_CoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgresses_CourseLessonsId",
                table: "LessonProgresses",
                column: "CourseLessonsId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonProgresses_CoursesId",
                table: "LessonProgresses",
                column: "CoursesId");
